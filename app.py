...
st.markdown("""
<style>
    /* Additional Streamlit-specific overrides using CSS variables */
    .stApp {
...
st.markdown("""
<div class="main-header fade-in-scale">
    <div class="header-content">
        ...
        <p class="subtitle">
            <span class="highlight">AI-Based</span> Student Behavior Analysis & Personalized Study Recommendation System
        </p>
